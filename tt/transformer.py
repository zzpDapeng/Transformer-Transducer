...
class RelLearnableMultiHeadAttn(RelMultiHeadAttn):
    ...
    def forward(self, w, r_emb, r_w_bias, r_bias, attn_mask=None):
        ...
        # w‘:  [seq_len, batch_size, d_model],[2, 18, 512]
        ...
        w_head_q, w_head_k, w_head_v = torch.chunk(w_heads, 3, dim=-1)  # [seq_len, batch_size, n_head*d_head] [18, 2, 512]

        klen = w_head_k.size(0)  # seq_len 18

        w_head_q = w_head_q.view(qlen, bsz, self.n_head, self.d_head)  # [seq_len, batch_size, n_head, d_head]  [18, 2, 8, 64]
        ...
        #### compute attention probability todo
