...
if __name__ == '__main__':
    ...
    file = '../audio/party_crowd.wav'
    noise_data, _ = read_wave_from_file(file)
    feature = get_feature(noise_data)
    tensor_to_img(feature)

    audio_data = noise_augmentation(audio_data, ['../party_crowd.wav'])
    # audio_data = time_shift_numpy(audio_data)

    out_file = '../audio/noise_augmentation.wav'
    feature = get_feature(audio_data)
